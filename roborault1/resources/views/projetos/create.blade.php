                    ...
                    <form role="form" method="POST" action="/projetos" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                {{-- A designação apensa permite letras e espaços --}}
                                <input type="text" class="form-control" onkeypress="return /[A-Za-z\s]/i.test(event.key)" name="inputDesignation" id="inputDesignation"
                                    placeholder="Insira a desginação do projeto" required value="{{ old('inputDesignation') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="inputResponsibles" name="inputResponsibles"
                                    placeholder="Insira o(s) aluno(s) responsável(eis)" required value="{{ old('inputResponsibles') }}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input type="date" class="form-control" id="inputInitialDate"
                                        name="inputInitialDate" required value="{{ old('inputInitialDate') }}">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="inputGitHub" name="inputGitHub"
                                    placeholder="Insira o repositório de GitHub utilizado" required value="{{ old('inputGitHub') }}">
                                @error('inputGitHub')
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" rows="5" id="inputDescription" name="inputDescription"
                                    placeholder="Insira a descrição do projeto" required>{{ old('inputDescription') }}</textarea>
